 ...
 */
FluxContext.prototype.executeAction = function executeAction(action, payload) {
    payload = payload || {};
    debug('Executing action ' + (action.name) + ' with payload', payload);
    return action(this.getActionContext(), payload);
};
...
FluxContext.prototype.getComponentContext = function getComponentContext() {
    ...
    var componentContext = {
        ...
        executeAction: function componentExecuteAction(action, payload) {
            return self.executeAction(action, payload)
              .catch(function(err) {
